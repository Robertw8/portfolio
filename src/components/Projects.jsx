	...
	const projects = [
		{
			...
			imageSrc: "src/assets/images/projects/spot.jpg", // Змініть шлях до зображення
		...
		},
		{
			...
			imageSrc: "src/assets/images/projects/images.jpg", // Змініть шлях до зображення
		...
		},
		{
			...
			imageSrc: "src/assets/images/projects/web-studio.jpg", // Змініть шлях до зображення
			technologies: ["HTML/CSS", "JavaScript"],
